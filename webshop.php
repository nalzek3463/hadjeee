...
// Postavite broj proizvoda po stranici i trenutnu stranicu
$proizvodaPoStranici = 30;
$trenutnaStranica = isset($_GET['page']) ? $_GET['page'] : 1;
$offset = ($trenutnaStranica - 1) * $proizvodaPoStranici;

// Izračunajte ukupan broj proizvoda
$sqlCount = 'SELECT COUNT(*) as total FROM dijelovi1';
$resultCount = mysqli_query($conn, $sqlCount);
$rowCount = mysqli_fetch_assoc($resultCount);
$totalProizvoda = $rowCount['total'];

// Izradite SQL upit s LIMIT i OFFSET za trenutnu stranicu
$sql = "SELECT id, artikal, marka, tip, kb, kw, ccm, slika1, slika2, slika3 FROM dijelovi1 ORDER BY id DESC LIMIT $proizvodaPoStranici OFFSET $offset";
                                        ...
                                        <div class="products-list__item">
                                                <div class="product-card">
                                                    ...
                                                    <div class="product-card__info">
                                                        ...
                                                        <div class="product-card__meta"><span class="product-card__meta-title"><b>ID: $id</b></span></div>
